    ...
    {% if post.tags contains 'song' %}
      <li>
        ...
        <div class="post-content" style="font-family: Palatino;">
          ...
          <div style="display: flex; align-items: center; justify-content: center; width: 100%; height: 250px; background-image: url('/imgs/Back.png'); box-sizing: border-box;">
    <iframe 
      class="dynamic-music-embed" 
      data-testid="embed-iframe" 
      style="border-radius: 12px; border: none; min-height: 152px !important; max-height: 250px !important; width: 90%; height: 100% !important; padding: 10px 0px" 
