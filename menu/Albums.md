...
<ul>
  ...
  <div style="position: relative; width: 100%; height: 160px; background-image: url('/imgs/Back.png'); box-sizing: border-box; padding: 10px; overflow: hidden">
    ...
    <div style="position: absolute; width: 690px; height: 160px; border-radius: 12px; overflow: hidden; z-index: 3;">
      <iframe 
        ...
        style="height: 160px !important; margin: 10px 0px; border: none;" 
